...
describe('BiomeQuad', () => {
    it('interpolates between biomes', () => {
        let biome1 = new Biome(vec3.fromValues(0, 0, 0), 0);
        let biome2 = new Biome(vec3.fromValues(0, 1, 0), 0.25);
        let biome3 = new Biome(vec3.fromValues(1, 0, 0), 0.5);
        let biome4 = new Biome(vec3.fromValues(1, 1, 0), 0.75);
        ...
        expect(quad.bilerp(vec3.fromValues(0, 0, 0.5))).to.eql(new Biome(vec3.fromValues(0, 0.5, 0), 0.125));
        expect(quad.bilerp(vec3.fromValues(0.5, 0, 0))).to.eql(new Biome(vec3.fromValues(0.5, 0, 0), 0.25));
        expect(quad.bilerp(vec3.fromValues(0.5, 0, 0.5))).to.eql(new Biome(vec3.fromValues(0.5, 0.5, 0), 0.375));
    });
