...
export class Shader {
    ...
    constructor(gl: WebGLRenderingContext,
        ...
        let eyePositionULoc = gl.getUniformLocation(this.shaderProgram, "uEyePosition"); // ptr to eye position
        ...
        let lightPositionULoc = gl.getUniformLocation(this.shaderProgram, "uLightPositions"); // ptr to light position
        ...
        var lightPosition = vec3.fromValues(1, 1, 1); // default light position

        var ambient = vec3.fromValues(0.1, 0.1, 0.1); // default ambient emission
        var diffuse = vec3.fromValues(0.6, 0.0, 0.0); // default diffuse emission
        var specular = vec3.fromValues(0.3, 0.0, 0.3); // default specular emission
        ...
        gl.uniform3fv(eyePositionULoc, eye); // pass in the light's ambient emission
